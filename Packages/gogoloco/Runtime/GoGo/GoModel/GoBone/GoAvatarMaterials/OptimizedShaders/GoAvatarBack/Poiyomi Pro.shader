Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/d904b2ab1a65c2949906b87b1a9aa83f"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.0.30</color>", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.directColor = (0.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(_LightColor0.rgb, (1.0 /*_LightingAdditiveLimit*/)) : _LightColor0.rgb;
